...
|---|---|---|---|
| [`velo-meteo`](velo-meteo/) | 0.2.0 | 8100 | Trajet et prévisions réels |
...
Open-Meteo sur chaque point de passage. Tant qu'aucun trajet n'est configuré — ou si une
API externe tombe — il tourne sur un jeu de données fictif, ce qui permet aussi de juger
le layout des pages hors ligne.
