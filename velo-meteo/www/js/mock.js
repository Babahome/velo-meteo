...
(function (w) {
  ...
  var MORNING = {
    ...
    points: [
      { i: 0, time: '08:00', label: 'Départ · Nation', x: 0.10, y: 0.80, rate: 0.0, prob: 15, temp: 12 },
      { i: 1, time: '08:04', label: 'Bd Voltaire', x: 0.19, y: 0.72, rate: 0.6, prob: 30, temp: 12 },
      { i: 2, time: '08:08', label: 'Père-Lachaise', x: 0.30, y: 0.70, rate: 3.2, prob: 55, temp: 12 },
      { i: 3, time: '08:12', label: 'République', x: 0.38, y: 0.56, rate: 8.0, prob: 85, temp: 11 },
      { i: 4, time: '08:16', label: 'Bd Saint-Martin', x: 0.52, y: 0.50, rate: 11.0, prob: 90, temp: 11 },
      { i: 5, time: '08:20', label: 'Grands Boulevards', x: 0.62, y: 0.36, rate: 4.5, prob: 60, temp: 11 },
      { i: 6, time: '08:23', label: 'Rue Montmartre', x: 0.78, y: 0.33, rate: 1.0, prob: 35, temp: 12 },
      { i: 7, time: '08:26', label: 'Arrivée · Bourse', x: 0.90, y: 0.22, rate: 0.0, prob: 20, temp: 12 }
    ],
  ...
  var EVENING = {
    ...
    points: [
      { i: 0, time: '18:00', label: 'Départ · Bourse', x: 0.90, y: 0.22, rate: 0.0, prob: 10, temp: 16 },
      { i: 1, time: '18:04', label: 'Rue Montmartre', x: 0.78, y: 0.33, rate: 0.0, prob: 10, temp: 16 },
      { i: 2, time: '18:08', label: 'Grands Boulevards', x: 0.62, y: 0.36, rate: 0.0, prob: 15, temp: 16 },
      { i: 3, time: '18:13', label: 'Bd Saint-Martin', x: 0.52, y: 0.50, rate: 0.0, prob: 15, temp: 15 },
      { i: 4, time: '18:17', label: 'République', x: 0.38, y: 0.56, rate: 0.3, prob: 20, temp: 15 },
      { i: 5, time: '18:21', label: 'Père-Lachaise', x: 0.30, y: 0.70, rate: 0.0, prob: 20, temp: 15 },
      { i: 6, time: '18:25', label: 'Bd Voltaire', x: 0.19, y: 0.72, rate: 0.0, prob: 15, temp: 15 },
      { i: 7, time: '18:28', label: 'Arrivée · Nation', x: 0.10, y: 0.80, rate: 0.0, prob: 10, temp: 15 }
    ],
